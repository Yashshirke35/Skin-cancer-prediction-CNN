...
path1 = 'C:/Users/COMPUTER/Downloads/archive/Skin cancer ISIC The International Skin Imaging Collaboration/Test/basal cell carcinoma'    #path of folder of images    
path2 = 'E:/final code/skin cancer Desktop 100% code/testing_set/5'  #path of folder to save images    
